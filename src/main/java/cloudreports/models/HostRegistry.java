...
public final class HostRegistry implements Serializable{
    ...
    /**
     * Gets the host's power model class name suffix.
     *
     * @return
     */
    ...
    /**
     * Sets the host's power model class name suffix.
     *
     * @param   powerModel the host's power model class name suffix to set
     */
    ...
    /**
     * Gets the host's RAM provisioner class name suffix.
     *
     * @return
     */
    ...
    /**
     * Sets the host's RAM provisioner class name suffix.
     *
     ...
     *
     * @param bwProvisioner    the host's bandwidth provisioner.
     */
    ...
    /**
     * Gets the host's processing elements provisioner class name suffix.
     *
     * @return
     */
    ...
    /**
     * Sets the host's processing elements provisioner class name suffix.
     *
