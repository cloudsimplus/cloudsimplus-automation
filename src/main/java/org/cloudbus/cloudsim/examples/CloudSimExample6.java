...
public class CloudSimExample6 {
	...
	private static List<Vm> vmlist;
         ...
         * @param userId The BrokerId that represents the user
         * @param vms Number of VMs to be created in behalf of the user.
	...
	private static List<Vm> createVM(int userId, int vms) {
         ...
         * @param userId The BrokerId that represents the user
         * @param vms Number of Cloudlets to be created in behalf of the user.
	...
	private static List<Cloudlet> createCloudlet(int userId, int cloudlets){
		...
		//cloudlet parameters
		long length = 1000; //in MI (Millions of Instructions)
		long fileSize = 300;
		long outputSize = 300;
		int pesNumber = 1;
